...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Add, move, or reorganize files                                                                   | `foundation/core/standards/governance_structure_standard.md`, `foundation/platforms/web-react/standards/naming_conventions.md`, `standards/project_structure.md`                                                                                                                                  |
